...
## ✅ 3A. Position-Specific Sub-Models (HIGH IMPACT) — done
...
## ✅ 3B. IterativeImputer for Missing Features (vs. Median Fill) — done
...
## ✅ 3C. Target Encoding for Categorical Features — done
...
## ✅ 3D. Outlier Capping & Robust Normalization — done
...
## ✅ 3E. Track-Type Ensemble Weights — done
...
## ✅ 3F. Optuna Monthly Hyperparameter Refresh — done
...
|-------------|----------------|--------|----------|--------|
| Position-specific sub-models | 0.06–0.10 | 4–6 hrs | **P1** | ✅ done |
| IterativeImputer (vs median) | 0.02–0.04 | 1–2 hrs | **P1** | ✅ done |
| Target encoding (high-cardinality) | 0.02–0.04 | 2–3 hrs | **P2** | ✅ done |
| Outlier capping + RobustScaler | 0.01–0.02 | 1 hr | **P2** | ✅ done |
| Track-type ensemble weighting | 0.02–0.04 | 2–3 hrs | **P2** | ✅ done |
| Monthly Optuna HPO refresh | 0.02–0.04 | 3–4 hrs | **P2** | ✅ done |
