#!/usr/bin/env python3
"""
Train LightGBM models for position prediction.
...
def train_lightgbm_models():
    """Train all LightGBM models and save to data_files/models/lightgbm/"""
    
    print("=" * 60)
    print("LightGBM Model Training")
    print("=" * 60)
    
    output_dir = Path("data_files/models/lightgbm")
    ...
    # Train position prediction model with LightGBM
    print("\n" + "-" * 60)
    print("Training Position Prediction Model (LightGBM)")
    print("-" * 60)
    ...
    save_training_manifest(
        ...
        model_name='position', model_version=f'lightgbm-{CACHE_VERSION}', estimator='LightGBM',
...
if __name__ == '__main__':
    try:
        metadata = train_lightgbm_models()
        sys.exit(0)
